...
def test_get_activities_extra(requests_mock, mocker):
    """ Should successfuly get activities when there is extra data."""
    ...
    response = [{"id": 1, "name": "Morning Run", "sport_type": "Run", "distance": 1000.0,
                 "elapsed_time": 60, "average_heartrate": 1.0, "average_speed": 1.0,
                 "start_date_local": "2024-01-01T08:00:00Z", "extra_field": "ignore"}]
